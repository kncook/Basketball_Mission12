...
//function for heading and caption after
function Welcome() {
  return(
    <div>
      <h1>NCAA Basketball</h1>
      <p>Below is a list of all NCAA Basketball teams with their associated school name, mascot name, city and state.</p>
    </div>);
}

//class that returns a card of a team
// this.props = for this obj here are the entries, these properties
...
//function that allows you to see all teams
function TeamList() {
  return (
  <div>
...
//this is the app that calls the functions
function App() {
  return (
  <div>
      <Welcome/>
